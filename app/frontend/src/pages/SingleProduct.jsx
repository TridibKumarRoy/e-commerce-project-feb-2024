                ...
                <div class="product-meta">
                  <ul class="list-inline">
                    <li class="list-inline-item">
                      ...
                      <a href="user-profile.html">Andrew</a>
                    </li>
                    <li class="list-inline-item">
                    ...
                    <li class="list-inline-item">
                      ...
                      <a href="category.html">Dhaka Bangladesh</a>
                    </li>
                  </ul>
                </div>
                ...
                <div class="product-slider">
                  <Slider {...settings}>
                    <div
                      ...
                      data-image="https://wdo.org/wp-content/uploads/2019/06/IMG_2981.jpg"
                    >
                      <img
            ...
            <div class="col-lg-4">
              <div class="sidebar">
                ...
                <div class="widget user text-center">
                  <img
                    class="rounded-circle img-fluid mb-5 px-5"
                    src="images/user/user-thumb.jpg"
                    alt=""
                  />
                  <h4>
                    <a href="user-profile.html">Jonathon Andrew</a>
                  </h4>
                ...
                <div class="widget coupon text-center">
                  ...
                  <a href="single.html" class="btn btn-transparent-white">
                    Submit Listing
                  </a>
                </div>
              </div>
